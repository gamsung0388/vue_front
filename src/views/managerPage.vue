    ...
    <div class="selectList">
        <div v-if="selected==false">
            ...
            <div>
                ...
                <button @click="() => boardTwoTrueDelete()">삭제</button>
                <br>
      ...
      methods: {
          ...
          boardTwoTrueDelete(){
            ...
            if(this.selectList.length==0){
              ...
              this.boardTrueDelete(params)
            }
          },
  
          boardTrueDelete(params){
            this.axios.get("/board/truedelete?checkList="+encodeURIComponent(JSON.stringify(params.checkList)))
            .then(res => {
              console.log(res.data);  
              this.boardSelect();
